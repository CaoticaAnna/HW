...
public class SdekTest {
    private static WebDriver driver;
    @BeforeClass
    public static void setup() {
        System.setProperty("webdriver.chrome.driver", "/Users/aguseva/IdeaProjects/sdek/target/chromedriver");
    ...
    public void lk_submenu3() {
        ...
        cityTo.click();
        WebElement cityToEnter = driver.findElement(By.xpath("/html/body/div[1]/div/div/div[2]/div[2]/div[2]/div/form/div[2]/div[3]/input"));
        cityToEnter.sendKeys("Новосиб");
        WebElement selectTo = (new WebDriverWait(driver, 100)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/ul[2]/li[contains(text(), 'Новосибирск, Новосибирская обл., Россия')]")));
        selectTo.click();
    ...
    public void lk_submenu4() {
        ...
        streetFromEnter.sendKeys("Русс");
        WebElement selectStreetFrom = (new WebDriverWait(driver, 100)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/ul[5]/li[contains(text(), 'РУССКАЯ УЛ')]")));
        selectStreetFrom.click();
        WebElement senderPhone = driver.findElement(By.xpath("//*[@id=\"sender-block\"]/div[3]/div/input[1]"));
        senderPhone.sendKeys("89137564535");
        WebElement senderHouse = driver.findElement(By.id("dSenderHouse"));
        senderHouse.sendKeys("10");
        ...
        receiverName.sendKeys("Гусева Анна Александровна");
        ...
        streetToEnter.sendKeys("Русс");
        WebElement selectStreetTo = (new WebDriverWait(driver, 100)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/ul[6]/li[contains(text(), 'РУССКАЯ УЛ')]")));
        selectStreetTo.click();
        WebElement receiverPhone = driver.findElement(By.xpath("//*[@id=\"receiver-block\"]/div[3]/div/input[1]"));
        receiverPhone.sendKeys("89059586513");
        WebElement receiverHouse = driver.findElement(By.id("dReceiverHouse"));
        receiverHouse.sendKeys("33");
        WebElement receiverRoom = driver.findElement(By.id("dReceiverRoom"));
        receiverRoom.sendKeys("80");
        ...
        WebElement orderPeriod = driver.findElement(By.xpath("//*[@id=\"orderhistoryform-date_period\"]"));
        orderPeriod.click();
        WebElement periodWeek = (new WebDriverWait(driver, 100)).until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#orderhistoryform-date_period > option:nth-child(1)")));
        periodWeek.click();
        WebElement orderStatus = driver.findElement(By.cssSelector("#orderhistoryform-status"));
        orderStatus.click();
        WebElement statusCreate = (new WebDriverWait(driver, 100)).until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#orderhistoryform-status > option:nth-child(2)")));
        statusCreate.click();
        ...
        WebElement orderLink = (new WebDriverWait(driver, 500)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div/div/div[2]/div[3]/div[2]/div[1]/table/tbody/tr[2]/td[7]/a[4]")));
        (new WebDriverWait(driver, 500)).until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div/div[2]/div[3]/div[2]/div[1]/table/tbody/tr[2]/td[7]/a[4]")));
        System.out.println(orderLink.getAttribute("href/a"));
        executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click()", orderLink);
        WebElement orderClose = (new WebDriverWait(driver, 100)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"order-info-modal\"]/div/div/div[3]/button")));
        orderClose.click();
        WebElement exit = (new WebDriverWait(driver, 100)).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"nav1\"]/li[2]/a")));
        (new WebDriverWait(driver, 500)).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"nav1\"]/li[2]/a")));
        executor = (JavascriptExecutor)driver;
        executor.executeScript("arguments[0].click()", exit);
    }
    @Test
    public void lk_submenu6() {
        WebElement login = driver.findElement(By.id("loginform-login"));
        login.sendKeys("ma.shishkin");
        WebElement Passwd = driver.findElement(By.id("loginform-password"));
        Passwd.sendKeys("192168113");
