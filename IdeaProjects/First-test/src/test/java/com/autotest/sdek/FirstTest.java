...
public class FirstTest {
    ...
    public void lk_submenu4() {
        ...
        WebElement orderPeriod = driver.findElement(By.xpath("//*[@id=\"orderform-date_period\"]"));
        orderPeriod.click();
        WebElement periodWeek = (new WebDriverWait(driver, 100)).until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#orderform-date_period > option:nth-child(1)")));
        periodWeek.click();
        WebElement orderStatus = driver.findElement(By.cssSelector("#orderform-status"));
        orderStatus.click();
        WebElement statusCreate = (new WebDriverWait(driver, 100)).until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#orderform-status > option:nth-child(2)")));
        statusCreate.click();
